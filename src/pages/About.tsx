    ...
    <div className="max-w-screen-lg p-8 flex flex-col gap-4">
      ...
      <div>
        ...
        <p className="text-xl">
          ...
          collaborate/coordinate with other individuals and work towards the
          goal of growing, educating, and promoting the Ethereum ecosystem. We
          believe Ethereum is technology for good and want to play a role in its
          adoption within and outside of crypto.
        </p>
      </div>
      <div>
        ...
        <p className="text-xl">
          ...
          research shop, and mad science lab rolled into one&mdash;a place where
          talented people can come together to build, research, write, and
